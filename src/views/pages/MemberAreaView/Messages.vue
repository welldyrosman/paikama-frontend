        ...
        <div class="content-msg">
            ...
            <div ref="contentbox" class="content-box">
                <div class="f-12 text-grey400 text-center px-2">
                    Hati-hati penipuan! Mohon tidak bertransaksi di luar Paikama & hindari menghubungi penjual selain
            ...
            <div class="row g-2 mx-2 mb-3">
                <div class="col-11">
                    <input type="text" v-on:keyup="keypress($event)" v-model="mytyping" placeholder="tulis pesan disini"
                        class="form-control" />
                </div>
                <div class="col-auto">
